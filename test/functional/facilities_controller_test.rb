...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { addr: @facility.addr, lat: @facility.lat, lon: @facility.lon, name: @facility.name, tel: @facility.tel, type: @facility.type }
    end
  ...
  test "should update facility" do
    put :update, id: @facility, facility: { addr: @facility.addr, lat: @facility.lat, lon: @facility.lon, name: @facility.name, tel: @facility.tel, type: @facility.type }
    assert_redirected_to facility_path(assigns(:facility))
  end
